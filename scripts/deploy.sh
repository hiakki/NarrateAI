...
# ─────────────────────────────────────────────────────────────────────────────
# NarrateAI — One-Command Deployment
#
...
#
# Usage:
#   ./scripts/deploy.sh                                        # fresh deploy
#   ./scripts/deploy.sh --restore backups/full-backup.tar.gz   # deploy + restore
#   ./scripts/deploy.sh --skip-prereqs                         # skip installs
#   ./scripts/deploy.sh --skip-prereqs --restore backup.tar.gz
#   ./scripts/deploy.sh --stop                                 # stop all services
#   ./scripts/deploy.sh --status                               # show running status
#
